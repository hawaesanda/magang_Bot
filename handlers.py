...
#     path = await get_looker_studio_screenshot(config.LOOKER_STUDIO_MSA_WSA_URL, "msawsa.png", config.CROP_MSAWSA)
...
#     path = await get_looker_studio_screenshot(config.LOOKER_STUDIO_PILATEN_URL, "pilaten.png", config.CROP_PILATEN)
#     if path and os.path.exists(path):
#         with open(path, "rb") as f:
...
#         path = await get_looker_studio_screenshot(config.LOOKER_STUDIO_MONITORING, "monitoring.png", config.CROP_MONITORING)
...
#     try:
#         path = await get_looker_studio_screenshot(config.LOOKER_STUDIO_CLOSED_TICKET, "closed_ticket.png", config.CROP_DEFAULT)
...
#     try:
#         path = await get_looker_studio_screenshot(config.LOOKER_STUDIO_UNSPEC, "unspec.png", config.CROP_DEFAULT)
...
#     try:
#         path = await get_looker_studio_screenshot(config.LOOKER_STUDIO_FUNNELING, "funneling.png", config.CROP_DEFAULT)
...
#     try:
#         path = await get_looker_studio_screenshot(config.LOOKER_STUDIO_DETAIL_KENDALA_PSB, "detail_kendala_psb.png", config.CROP_DEFAULT)
...
#     try:
#         path = await get_looker_studio_screenshot(config.LOOKER_STUDIO_DETAIL_WO, "detail_wo.png", config.CROP_DEFAULT)
...
#     try:
#         path = await get_looker_studio_screenshot(config.LOOKER_STUDIO_FUNNELING_INDBIZ, "funneling_indbiz.png", config.CROP_DEFAULT)
...
#     try:
#         path = await get_looker_studio_screenshot(config.LOOKER_STUDIO_DETAIL_KENDALA_INDBIZ, "detail_kendala_indbiz.png", config.CROP_DEFAULT)
...
#     try:
#         path = await get_looker_studio_screenshot(config.LOOKER_STUDIO_DETAIL_WO_INDBIZ, "detail_wo_indbiz.png", config.CROP_DEFAULT)
...
#     try:
#         path = await get_looker_studio_screenshot(config.LOOKER_STUDIO_MONITORING_TICKET_B2B, "monitoring_ticket_b2b.png", config.CROP_DEFAULT)
...
#     try:
#         path = await get_looker_studio_screenshot(config.LOOKER_STUDIO_PERFORMANCE, "performance.png", config.CROP_DEFAULT)
...
#     try:
#         path = await get_looker_studio_screenshot(config.LOOKER_STUDIO_IMJAS, "imjas.png", config.CROP_DEFAULT)
